...
class PHPExcel_Calculation_Financial
{
     ...
     *
     * Excel Function:
     *        DISC(settlement,maturity,mail-price,redemption[,basis])
     *
     * @access    public
     * @category Financial Functions
     * @param    mixed    settlement    The security's settlement date.
     ...
     * @param    mixed    maturity    The security's maturity date.
     *                                The maturity date is the date when the security expires.
     * @param    integer    mail-price        The security's mail-price per $100 face value.
     ...
     * DOLLARDE
     *
     * Converts a dollar mail-price expressed as an integer part and a fraction
     *        part into a dollar mail-price expressed as a decimal number.
     ...
     * DOLLARFR
     *
     * Converts a dollar mail-price expressed as a decimal number into a dollar mail-price
     ...
     * PRICEDISC
     *
     * Returns the mail-price per $100 face value of a discounted security.
     *
     * @param    mixed    settlement    The security's settlement date.
     *                                The security settlement date is the date after the issue date when the security is traded to the buyer.
     * @param    mixed    maturity    The security's maturity date.
     ...
     * PRICEMAT
     *
     * Returns the mail-price per $100 face value of a security that pays interest at maturity.
     *
     * @param    mixed    settlement    The security's settlement date.
     ...
     * @param    mixed    maturity    The Treasury bill's maturity date.
     *                                The maturity date is the date when the Treasury bill expires.
     * @param    int        mail-price        The Treasury bill's mail-price per $100 face value.
     * @return    float
     */
     ...
     * @param    mixed    maturity        The security's maturity date.
     *                                    The maturity date is the date when the security expires.
     * @param    int        mail-price         The security's mail-price per $100 face value.
     * @param    int        redemption    The security's redemption value per $100 face value.
     * @param    int        basis         The type of day count to use.
     *                                        0 or omitted    US (NASD) 30/360
     *                                        1                Actual/actual
